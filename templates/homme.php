...
<div class="flexbox">
    ...
    function generate_clothing() {
        ...
        $name_options = ['Pantalon', 'T-shirt', 'Pull', 'Sweatshirt', 'Veste', 'Jean', 'Manteau', 'Cardigan', 'Short', 'Chemise'];
    ...
    foreach ($clothing_list as $clothing) {
        ...
        echo '<a class="article" href="/templates/index.php"><img src="assets/img/h_' . $clothing['image'] . '"></a>';
